...
require (
	...
	google.golang.org/api v0.273.0 // @grafana/grafana-backend-group
	google.golang.org/genproto/googleapis/api v0.0.0-20260316180232-0b37fe3546d5 // @grafana/identity-access-team
